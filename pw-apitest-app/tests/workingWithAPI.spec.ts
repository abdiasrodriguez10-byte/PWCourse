...
test('delete article', async ({page, request}) => {
  ...
  //  data: {
    //  "user": {"email":"pwtest099@test.com","password":"Welcome1"}
    //}
  //})
  //const responseBody = await response.json()
  ...
  const articleResponse = await request.post('https://conduit-api.bondaracademy.com/api/articles/', {
    data: {
      "article":{"tagList":[],"title":"This is a test article","description":"This is a test description","body":"This is a test body"}
    }, 
    //headers: {
